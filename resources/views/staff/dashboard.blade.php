        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition duration-200 flex flex-col justify-between h-56">
                    ...
                    <div class="mt-6">
                        <a href="{{ url('/katalog') }}" class="block text-center bg-green-600 text-white font-semibold py-3 rounded-lg hover:bg-green-700 transition">
                            Buka Halaman Kasir
                        </a>
                    </div>
                </div>
            ...
            <div class="mt-8 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-6 rounded-2xl shadow-lg flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <a href="/tanya-medis" class="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-lg hover:bg-indigo-50 transition whitespace-nowrap">
                    Tanya Sekarang
                </a>
            </div>
        </div>
